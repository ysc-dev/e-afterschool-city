	...
	<div class="content-wrapper">
		<div class="content">
			<div class="cotent-title justify-content-center align-items-center">
				<span>경남교육청 <span class="text-primary">캠퍼스형</span> 방과후학교</span>
				<span>오신것을 환영합니다.</span>
			</div>
			
			<div class="row mt-4">
				<div class="col-6">
					<button type="button" id="registBtn" class="btn btn-box btn-outline bg-light border-slate-300">
						<div class="py-3">
							<p>처음이십니까?</p>
				...
				<div class="col-6"> 
					<button type="button" class="btn btn-box btn-outline bg-light border-slate-300">
						...
						<div class="card-body">
							<div class="card-box">
								<div class="text-center">
									수강신청주소<br>
									<span class="fs-12">http://e-afterschool.kr</span>
								</div>
